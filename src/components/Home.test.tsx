...
describe('Home Component', () => {
  ...
  test('navigation buttons call navigation functions when clicked', () => {
    // Mock window.location.assign to check URL redirection
  ...
  test('component structure is correct and contains appropriate classes', () => {
    render(<Home />);
