...
describe('Home Component', () => {
  ...
  // We cannot fully test navigation, but we can simulate clicks without errors
  test('navigation buttons click simulate', () => {
    render(<Home />);
    const productsButton = screen.getByText('Go to Products');
    const aboutButton = screen.getByText('Go to About');
  ...
  test('main container and sections have correct classNames', () => {
    render(<Home />);
