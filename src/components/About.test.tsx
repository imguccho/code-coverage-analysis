...
describe('About Component', () => {
  ...
  test('renders company statistics section and details', () => {
    render(<About />);
  ...
  test('renders team section with title and all members', () => {
    ...
    // Check all team members rendered
    ...
    // Check correct number of team members
    const experienceElements = screen.getAllByText(/Experience:/);
    expect(experienceElements).toHaveLength(6);
  });

  test('team member cards display correct information and calculated experience level', () => {
    render(<About />);
    ...
    // Check other experience levels too
  ...
  test('renders company mission section and full description', () => {
    render(<About />);
  ...
  test('navigation functions can be fired on button clicks', () => {
    // Since navigation is via useNavigate, we cannot test actual routing
    // But we can simulate clicks and assert buttons remain
    render(<About />);
    const homeButton = screen.getByText('Go to Home');
    const productsButton = screen.getByText('Go to Products');
