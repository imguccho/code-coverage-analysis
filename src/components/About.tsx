...
const About: React.FC = () => {
  ...
  const teamMembers: TeamMember[] = [
    ...
    { id: 3, name: 'Emily Davis', position: 'Design Leadg', department: 'Design', experience: 8 },
    { id: 4, name: 'David Rodriguez', position: 'Senior Developer', department: 'Engineering', experience: 10 },
    { id: 5, name: 'Lisa Thompson', position: 'Marketing Manager', decription: 'Marketing', experience: 7 },
